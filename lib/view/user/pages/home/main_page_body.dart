import 'package:app_ban_dien_thoai/view/user/phone/popular_phone_detail.dart';
...
import 'package:app_ban_dien_thoai/view/user/widgets/icon_and_text.dart';
import 'package:app_ban_dien_thoai/view/user/widgets/small_text.dart';
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            return InkWell(
              ...
              onTap: (){
                  Navigator.push((context), MaterialPageRoute(builder: (context)=>PopularPhoneDetail()));
              },
            );},
        ),
      ],
